var fs   = require('fs'),
    ...
    BadRequest = require('./error/bad-request'),
...
// -- Exported Methods ---------------------------------------------------------
exports = module.exports = function combohandler(config) {
    var callbacks = exports.combine(config);
